# Code is designed by defining multiple function, 
# such that length of the code is reduced and multiple
# function calls can be made to make it faster.
...
if __name__ == '__main__':
    ...
    Doremon()
    my_goto(250, -230)
    write("by Tanveer Singh", font=("Arial", 15))
    mainloop()